              ...
              children: [
                ...
                Padding(
                  ...
                  child: TextFormField(
                    ...
                    validator: (value) {
                      ...
                      else if (!RegExp("^[a-zA-Z0-9+_.-]+@st.habib.edu.pk").hasMatch(value)) {
                ...
                Container(
                  ...
                  child: FlutterFlowCountController(
                    ...
                    incrementIconBuilder: (enabled) => FaIcon(
                      ...
                      color: enabled ? Color(0xFF821C8B) : Color(0xFFEEEEEE),
                      size: 20,
                    ),
                    ...
                    count: countControllerValue ??= sbatch, // CHANGE HERE
                    updateCount: (count) =>
                ...
                Padding(
                  ...
                  child: FlutterFlowDropDown(
                    initialOption: dropDownValue ??= sprogram,
                ...
                Padding(
                  ...
                  child: TextFormField(
                    ...
                    validator: (value) {
                      // check if field is empty
                      if (value!.isEmpty && yourAgeController3!.text.isNotEmpty) {
                ...
                Padding(
                  ...
                  child: TextFormField(
                    ...
                    validator: (value) {
                      // check if field is empty
                      if (value!.isEmpty && yourAgeController2!.text.isNotEmpty) {
                        return "Please enter a password";
                      }    
                    },
                  ),
                  ...
                  child: FFButtonWidget(
                    onPressed: () {
                      if (scaffoldKey.currentState!.validate()) {
                          ...
                          if(yourAgeController2!.text != yourAgeController3!.text)
                          {
